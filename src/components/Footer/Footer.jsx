            ...
            <Container>
                <div className={s.container}>
                    ...
                    <div className={s.social}>
                        <h2 className={cn(s.categoryTitle, s.title)}>Связаться с нами</h2>
                        <p className={s.socialSubtitle}>Контакты и адреса магазинов</p>
                        <ul className={s.socialList}>
                            <li>
                                <a href='#' className={cn(s.socialLinkVK, s.link)}>
                                    <svg
                                        width='24'
                                        height='24'
                                        viewBox='0 0 24 24'
                            ...
                            <li>
                                <a href='#' className={cn(s.socialLinkFB, s.link)}>
                                    <svg
                                        width='24'
                                        height='24'
                                        viewBox='0 0 24 24'
